...
/**
 * Lightweight harness to gauge transpilation cost for a representative query.
 */
public final class QueryBenchmark {
	...
	public static void main(String[] args) {
		...
		var query = QueryImpl.newQuery()
				...
				.having(Job.C_SALARY).avg(Job.C_SALARY).supOrEqTo(60000)
				.orderBy(Employee.C_LAST_NAME, SortDirection.DESC)
				.limitAndOffset(25, 0);
