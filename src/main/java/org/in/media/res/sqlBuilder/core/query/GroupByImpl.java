...
import org.in.media.res.sqlBuilder.core.query.factory.GroupByTranspilerFactory;
...
public class GroupByImpl implements GroupBy {
	...
	private final GroupByTranspiler groupByTranspiler = GroupByTranspilerFactory.instanciateGroupByTranspiler();
