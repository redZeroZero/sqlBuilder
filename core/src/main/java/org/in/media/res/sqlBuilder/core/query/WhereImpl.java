...
import org.in.media.res.sqlBuilder.core.query.transpiler.defaults.DefaultWhereTranspiler;
...
final class WhereImpl implements Where {
	...
	private final WhereTranspiler whereTranspiler = new DefaultWhereTranspiler();
